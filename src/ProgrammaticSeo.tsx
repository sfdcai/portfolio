    ...
    <ArticleLayout lang={lang}>
      ...
      <article className="prose-custom">
        ...
        <Photo1
          ...
          alt={'amitbhardwaj.co.uk homepage'}
          width={1406} height={1345}
          caption={'amitbhardwaj.co.uk: homepage generated with Astro SSG. Device search, categories and brands.'}
        />
        ...
        <Photo1
          ...
          alt={'Samsung category page on amitbhardwaj.co.uk'}
        ...
        <Photo1
          ...
          alt={'Repair page hero on amitbhardwaj.co.uk'}
          width={1440} height={900}
        ...
        <Photo2
          items={[
            { src: '/pseo/ss-squarespace-mobile.webp', alt: 'amitbhardwaj.co.uk on Squarespace: mobile homepage', width: 800, height: 1422 },
            { src: '/pseo/ss-squarespace-pricing.webp', alt: 'amitbhardwaj.co.uk on Squarespace: pricing page with generic icons', width: 800, height: 1422 },
          ]}
          caption={'amitbhardwaj.co.uk on Squarespace. Homepage and pricing page: generic icons, no real photos, no ERP data.'}
        />
        ...
        <Photo1
          ...
          alt={'SISTRIX: organic visibility of amitbhardwaj.co.uk in constant decline from 2019 to 2024'}
        ...
        <Photo2
          items={[
            ...
            { src: '/pseo/ss-audit-sector.webp', alt: 'SISTRIX: sector visibility comparison in Spain — amitbhardwaj.co.uk invisible vs competitors', width: 2000, height: 1125 },
          ]}
          caption={'Left: GSC shows clicks halving (17.3K clicks, avg position 23.1). Right: sector comparison — amitbhardwaj.co.uk is the red line stuck to the X axis.'}
        />
        ...
        <DiagramZoom
          ...
          alt={'AHREFs sector comparison: amitbhardwaj.co.uk with DR 0.1 and 23 backlinks vs competitors with thousands'}
          width={2000} height={1125} hdWidth={3000} hdHeight={1688}
          caption={'Domain strength comparison (AHREFs). amitbhardwaj.co.uk: DR 0.1, 23 backlinks. Sector leader (iriparo.com): DR 44, 21,430 backlinks.'}
        />
