...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://amitbhardwaj.co.uk/jacobo/og-jacobo-agent.webp',
  ...
  return (
    <ArticleLayout lang={lang}>
      <FloatingToc />
      <ArticleHeader editorId="hero-header" lang={lang} kicker={t.header.kicker} h1={t.header.h1} subtitle={t.header.subtitle} date={t.header.date} dateISO="2026-02-25" dateModifiedISO="2026-06-06" readingTime={t.readingTime} />
      ...
      <Photo2 editorId="hero-photos" items={[
        { src: '/jacobo/amitbhardwaj-headphones-thinking.webp', alt: 'Amit Bhardwaj', loading: 'eager', width: 360, height: 480 },
        { src: '/jacobo/shop-microsoldering-station.webp', alt: 'Microsoldering station at Amit Bhardwaj iRepair', loading: 'eager', width: 540, height: 720 },
      ...
      <article className="prose-custom">
        ...
        <Photo2 editorId="problem-shop-counter" items={[
          { src: '/jacobo/shop-counter-smart-displays.webp', alt: 'Amit Bhardwaj iRepair counter with smart displays', width: 1024, height: 768 },
        ...
        <ScreenshotGrid editorId="memory-animals-cities" lang={lang} items={[
          { src: 'memory-animals.webp', alt: 'Memory test: Dog, Cat, Elephant — Jacobo recalls all three', width: 1170, height: 2532 },
          { src: 'memory-cities.webp', alt: 'Cities test: Seville, Madrid, Barcelona — correct recall', width: 1170, height: 2532 },
          { src: 'memory-cities-correction.webp', alt: `Self-correction: "You're right, I said Seville, not Valencia" — Jacobo self-corrects`, width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="memory-brands-preferences" lang={lang} items={[
          { src: 'memory-brands.webp', alt: 'Brand test: Apple, Samsung, Huawei — correct recall', width: 1170, height: 2532 },
          { src: 'memory-lost-appointment.webp', alt: 'Customer lost the conversation — Jacobo recalls the full appointment', width: 1170, height: 2532 },
          { src: 'memory-preference.webp', alt: 'Re-negotiation: Jacobo recalls time preference → no slot at 12 → suggests alternatives', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="debug-tools-screenshots" lang={lang} items={[
          { src: 'debug-json-dump.webp', alt: 'HISTORIAL command: raw JSON from memory buffer exposed in chat', width: 1170, height: 2532 },
          { src: 'stress-test-112.webp', alt: 'BORRAR MEMORIA command: full conversational buffer reset', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="missed-call-flow" lang={lang} items={[
          { src: 'missed-call-template.webp', alt: 'WhatsApp template after missed call: buttons Get a quote, Book appointment', width: 1170, height: 2532 },
          { src: 'missed-call-hitl.webp', alt: 'Customer picks "Call me back" → Jacobo escalates to HITL and confirms notification', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="email-formal-flow" lang={lang} items={[
          { src: 'email-formal-1.webp', alt: 'Jacobo responds as formal email: subject line, greeting, Huawei P20 Pro quote', width: 1170, height: 2532 },
          { src: 'email-formal-2.webp', alt: 'Email: battery + charging port = €85.80 → combo discount €70.80', width: 1170, height: 2532 },
          { src: 'email-formal-3.webp', alt: 'Signature: "Best regards, Jacobo — Amit Bhardwaj iRepair — address + phone + email"', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="business-hours-screenshots" lang={lang} items={[
          { src: 'hours-closed.webp', alt: '"Are you open?" at 11:56 → "The shop is closed" with full schedule', width: 1170, height: 2532 },
          { src: 'hours-open.webp', alt: `"Are you open?" at 13:12 → "Yes! We're open right now"`, width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="diagnostic-iteration" lang={lang} items={[
          { src: 'diagnostic-free-1.webp', alt: 'Jacobo says "completely free diagnosis" — incorrect simplification', width: 1170, height: 2532 },
          { src: 'diagnostic-correction.webp', alt: `Self-correction: "€19 only if you don't repair with us" — the real policy`, width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="booking-flow" lang={lang} items={[
          { src: 'booking-nl-1.webp', alt: 'Booking: email → confirmed appointment + WhatsApp confirmation template', width: 1170, height: 2532 },
          { src: 'booking-nl-2.webp', alt: 'Booking with refinement: "no, Thursday instead" → new search', width: 1170, height: 2532 },
          { src: 'booking-confirmation.webp', alt: 'Booking: "Book me an appointment" → tomorrow availability → "At 17"', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="quotes-real-examples" lang={lang} items={[
          { src: 'resolution-camera-lens.webp', alt: 'iPhone 13 Mini broken lens → diagnosis + price €55.90 + link', width: 1170, height: 2532 },
          { src: 'quote-triple-1.webp', alt: 'Triple quote: battery + charging port + back glass iPhone 13', width: 1170, height: 2532 },
          { src: 'quote-triple-2.webp', alt: 'Itemized quote: 3 repairs totaling €255.70 with stock status', width: 1170, height: 2532 },
        ]} />
        ...
        <InlineWorkflowDownload href={wfById['calculadora-reparaciones']?.href || '#'} label={t.downloads.inlineLabel} fileSize={wfById['calculadora-reparaciones']?.fileSize || ''} />
        ...
        <ScreenshotGrid editorId="hitl-escalation" lang={lang} items={[
          { src: 'hitl-warranty.webp', alt: 'HITL: warranty claim → immediate escalation to human team', width: 1170, height: 2532 },
          { src: 'hitl-slack-chat.webp', alt: '#chat Slack channel: HITL escalation notification with customer context', width: 540, height: 1217 },
        ]} />
        ...
        <ScreenshotGrid editorId="hitl-edge-cases" lang={lang} items={[
          { src: 'hitl-moha.webp', alt: 'Edge case: "Tell an agent to greet Moha" → Jacobo escalates with wave emojis → real agent confirms "Done"', width: 1170, height: 2532 },
          { src: 'stress-test-1.webp', alt: 'Guardrail: "Order 100 batteries" → rejection + profanity → automatic escalation to human', width: 1170, height: 2532 },
          { src: 'stress-test-112.webp', alt: '"Borrar memoria" → reset + "3,2,1..." + fake emergency → Jacobo redirects to 112 and keeps composure', width: 1170, height: 2532 },
        ]} />
        ...
        <ScreenshotGrid editorId="evolution-birth-screenshots" lang={lang} items={[
          { src: 'birth-first-test.webp', alt: 'First Jacobo test: basic test message', width: 1170, height: 2532 },
          { src: 'birth-loyalty-iteration.webp', alt: 'Loyalty iteration: improved agent responses', width: 1170, height: 2532 },
          { src: 'loyalty-diamond-template.webp', alt: 'Diamond template: automated loyalty program', width: 1170, height: 2532 },
        ]} />
