...
projects:
  ...
  agentInfra:
    ...
    subtitle: |
        Testing and implementing local LLM reasoning loops.
    agents:
      - icon: brain
        ...
        tag: private
  items:
    - title: VisionVox AI Companion
      badge: Live · AI Voice/Vision
      badgeBuilding: ""
      desc: |
          A low-latency, real-time voice and vision assistant for the visually impaired. Built using the Gemini Multimodal Live API over WebSockets, performing spatial quadrant scans, real-time OCR, and proactive safety hazard alerts.
      tech:
        - Gemini Live API
        - WebSockets
        - React
        - Audio Streaming
        - OCR
      caseStudyUrl: "https://visionvox.amitbhardwaj.co.uk"
      caseStudyLabel: "Try Live App"
    - title: Salesforce DX AI Copilot
      badge: Live · AI Agent
      badgeBuilding: ""
      desc: |
          An AI-powered development companion for Salesforce DX. Accelerates engineering by automatically writing Apex test classes, generating package.xml manifests, performing security scans, and suggesting platform improvements.
      tech:
        - Claude API
        - Node.js
        - Salesforce CLI
        - Agentic Workflows
      caseStudyUrl: "https://sfdx.duckdns.org"
      caseStudyLabel: "Try Live App"
    - title: GitProtect Security Gate
      badge: Live · DevOps Security
      badgeBuilding: ""
      desc: |
          An automated security and compliance gateway for source control. Utilizes LLM agents to scan incoming commits and pull requests for leaked credentials, secrets, OWASP vulnerabilities, and enforces branch compliance rules.
      tech:
        - Python
        - LLM Agents
        - GitHub Webhooks
    ...
    - title: AI Product Information Platform
      ...
      badgeBuilding: ""
      desc: |
          A system designed to centralize product data and enhance it using AI-driven enrichment pipelines and translations.
      tech:
        - Python
        - FastAPI
        - OpenAI API
    ...
    - title: Home Lab Infrastructure
      ...
      badgeBuilding: ""
      desc: |
          A fully self-hosted Proxmox environment used for learning enterprise infrastructure, networking, and security.
      tech:
        - Proxmox
        - OpenWRT
        - pfSense
    ...
    - title: Enterprise Integration Architecture
      ...
      badgeBuilding: ""
      desc: |
          Designed scalable integration patterns between Salesforce CRM and enterprise backends like SAP using event-driven communication.
      tech:
        - Salesforce
        - SAP
        - Event Bus
